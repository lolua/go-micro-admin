...
var (
	...
	loginMysqlConfig        defaultMysqlConfig
	gmMysqlConfig           defaultMysqlConfig
	hallMysqlConfig         defaultMysqlConfig
...
func init() {
	...
	config.Get(defaultRootPath, "mysql", "login").Scan(&loginMysqlConfig)
	config.Get(defaultRootPath, "mysql", "gm").Scan(&gmMysqlConfig)
	config.Get(defaultRootPath, "mysql", "hall").Scan(&hallMysqlConfig)
...
func GetLoginMysqlConfig() (ret MysqlConfig) {
	return loginMysqlConfig
}

func GetGmMysqlConfig() (ret MysqlConfig) {
	return gmMysqlConfig
}

func GetHallMysqlConfig() (ret MysqlConfig) {
	return hallMysqlConfig
}
